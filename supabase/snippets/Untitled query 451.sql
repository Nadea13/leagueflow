...
USING ((("auth"."uid"() = "user_id") OR ((SELECT "users"."is_admin" FROM "public"."users" WHERE "users"."id" = "auth"."uid"()) = true)));

DROP POLICY IF EXISTS "payments_write" ON "public"."payments";
CREATE POLICY "payments_write" ON "public"."payments" TO "authenticated" 
USING (((SELECT "users"."is_admin" FROM "public"."users" WHERE "users"."id" = "auth"."uid"()) = true));
