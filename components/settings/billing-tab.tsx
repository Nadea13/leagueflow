                            ...
                            {selectedPlan && (
                                <>
                                    ...
                                    {getPlanPrice(selectedPlan) === 0 ? (
                                        <div className="flex justify-between items-center border rounded-sm p-2 md:p-4">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                                                ...
                                                <div className="flex-1 flex flex-col justify-center items-center w-full min-h-[140px] md:h-[398px] max-h-[398px]">
                                                    {!slipPreviewUrl ? (
                                                        ...
                                                        <div className="relative overflow-hidden border p-2 md:p-4 rounded-sm w-full h-full flex">
