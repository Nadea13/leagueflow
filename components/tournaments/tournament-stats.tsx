        ...
        <div className="grid gap-6 md:grid-cols-3">
            <Card className="rounded-none bg-card border border-border/40 relative overflow-hidden transition-all hover:border-secondary/50 group shadow-lg">
                ...
                <CardContent className="relative z-10">
                    <div className="text-3xl font-black italic uppercase tracking-tighter">{totalTeams}</div>
                    <p className="text-[10px] font-bold uppercase text-muted-foreground/40 mt-1">
            ...
            <Card className="rounded-none bg-card border border-border/40 relative overflow-hidden transition-all hover:border-secondary/50 group shadow-lg">
                ...
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                    ...
                    <CalendarDays className="h-4 w-4 text-secondary/40 group-hover:text-secondary transition-colors" />
                </CardHeader>
                <CardContent className="relative z-10">
                    <div className="text-2xl md:text-5xl font-black tracking-tighter italic leading-none">
                        {completedMatches} <span className="text-muted-foreground text-sm font-normal">/ {totalMatches}</span>
                    </div>
                    <p className="text-[10px] font-bold uppercase text-muted-foreground/40 mt-1">
            ...
            <Card className="rounded-none bg-card border border-border/40 relative overflow-hidden transition-all hover:border-secondary/50 group shadow-lg">
                ...
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                    ...
                    <Trophy className="h-4 w-4 text-secondary/40 group-hover:text-secondary transition-colors" />
                </CardHeader>
                <CardContent className="relative z-10">
                    <div className="text-3xl font-black italic uppercase tracking-tighter">{totalGoals}</div>
                    <p className="text-[10px] font-bold uppercase text-muted-foreground/40 mt-1">
