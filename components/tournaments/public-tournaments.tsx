        ...
        <div className="space-y-4 md:space-y-6">
            ...
            {isLoading ? (
                <div className="flex flex-col items-center justify-center py-24 gap-6 bg-muted/5 border border-dashed border-border/40 relative overflow-hidden group">
                    ...
                    <p className="text-secondary font-black uppercase tracking-[0.3em] text-xs animate-pulse relative z-10">{t("searching")}</p>
                </div>
                ...
                <div className="text-center py-24 border border-dashed border-border/40 bg-muted/5 relative overflow-hidden group">
                    ...
                    <p className="text-4xl font-black uppercase tracking-tighter text-muted-foreground/10 mb-2">{t("no_results")}</p>
                        ...
                        <div className="space-y-8">
                            {!onlyActive && (
                                <div className="flex items-center gap-6 mb-12">
                                    ...
                                    <h2 className="text-4xl font-black uppercase tracking-tighter text-foreground">{t("active_tournaments")}</h2>
                    ...
                    {!onlyActive && completedTournaments.length > 0 && (
                        <div className="space-y-4 md:space-y-6">
                            <div className="flex items-center gap-4 md:gap-6">
                                <h2 className="text-3xl font-black uppercase tracking-tighter text-muted-foreground/40">{t("completed_tournaments")}</h2>
