...
export function Tab<T extends string>({
  ...
  return (
    <div
      className={cn(
        "flex p-1 bg-muted/20 rounded-none gap-1 border border-border h-auto",
      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center justify-center gap-2 px-3 py-2 text-[10px] font-black uppercase transition-all rounded-none border-none",
