...
export function PricingCards({
    ...
    return (
        <div className="overflow-x-auto rounded-lg border bg-background shadow-sm pt-6">
                        ...
                        {sortedProducts.map(product => {
                            ...
                            return (
                                <th key={product.id} className={cn(
                                    ...
                                    {isRecommended && (
                                        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary text-primary-foreground text-[10px] uppercase font-bold px-2 py-0.5 rounded-full shadow-sm whitespace-nowrap z-10">
                                            {t('recommended')}
                                        </div>
                                    )}
