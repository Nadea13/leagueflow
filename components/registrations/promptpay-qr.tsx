        ...
        <div className="bg-card border border-border/10 shadow-2xl rounded-none overflow-hidden max-w-sm mx-auto">
            ...
            <div className="p-8 flex flex-col items-center gap-8">
                ...
                <div className="text-center space-y-2">
                    <p className="text-[10px] uppercase font-black italic tracking-widest text-muted-foreground/60">{t("amount")}</p>
                    <p className="text-3xl font-black italic uppercase tracking-tighter text-foreground leading-none">
            ...
            <div className="p-6 bg-muted/30 border-t border-border/10 space-y-4">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-black italic tracking-tight text-foreground">
