...
export function AdminSidebar({ className }: { className?: string }) {
    ...
    // normalize pathname to ensure matching works correctly 
    // e.g. /en/admin/users -> /admin/users checks
    ...
    return (
        <div className={cn("flex h-full max-h-screen flex-col gap-2 relative", className)}>
