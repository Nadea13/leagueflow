...
export default async function PublicViewPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { data: allEventsResult } = await adminSupa
        ...
        .order("minute", { ascending: true }); // Order by minute for timeline

    // Map events to include player_name
                ...
                <Tabs defaultValue="overview" className="w-full">
                    ...
                    <TabsContent value="overview" className="space-y-8">
                        ...
                        {tournament?.format === 'group_knockout' && (
                            <Card>
                                ...
                                <CardContent>
                                    <GroupStandings teams={teams || []} matches={matches || []} isPublic={true} />
                                </CardContent>
                            </Card>
                        )}
                        ...
                        {(tournament?.format === 'knockout' || tournament?.format === 'group_knockout') && (
                            <Card>
                                ...
                                <CardContent>
                                    <TournamentBracket matches={matches as Match[] || []} isPublic={true} />
                                </CardContent>
                            </Card>
                        )}
                    </TabsContent>
                    ...
                    <TabsContent value="matches">
                        <Card>
                            ...
                            <CardContent>
                                <PublicMatchList matches={matches || []} tournamentId={id} events={allEvents} />
                            </CardContent>
                        </Card>
                    </TabsContent>
                </Tabs>
