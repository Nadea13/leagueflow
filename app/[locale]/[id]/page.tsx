        ...
        return (
            <div className="min-h-screen bg-background overflow-x-hidden pt-16 print:pt-0 flex flex-col">
                ...
                <main className="flex-1 flex items-center justify-center p-6 md:p-12">
                    <div className="max-w-md w-full bg-background/50 border border-slate-200 dark:border-foreground/10 backdrop-blur-md shadow-2xl rounded-2xl p-8 text-center space-y-4 transition-all duration-300 hover:shadow-primary/5 hover:border-primary/20">
