...
function TournamentNavbar({ brandText, publicViewText }: { brandText: string; publicViewText: string }) {
    return (
            ...
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                <Link href="/" className="flex items-center gap-2 font-bold text-xl">
                    <svg viewBox="0 0 160 160" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M143.612 48.5996C144.14 48.5996 144.668 48.5996 145.212 48.5996C145.95 75.4476 143.218 103.372 125.212 124.6C124.536 125.405 123.861 126.21 123.165 127.04C114.98 136.526 99.6453 150.742 86.8117 152.6C84.5742 151.628 84.5742 151.628 82.2117 150.25C81.4238 149.797 80.636 149.344 79.8242 148.878C79.2261 148.522 78.628 148.166 79.8242 148.878C79.2261 148.522 78.628 148.166 78.0117 147.8C78.0117 145.4 78.0117 145.4 79.3117 144.04C79.9387 143.515 80.5657 142.99 81.2117 142.45C90.2309 134.585 98.7241 126.103 106.012 116.6C106.823 115.571 107.634 114.543 108.446 113.515C123.99 93.7006 135.136 72.2987 143.612 48.5996Z" fill="#0D2C54" />
                    ...
                    <span className="font-black text-foreground text-xl tracking-tighter">{brandText}</span>
                </Link>
                <div className="flex items-center gap-2">
                    <span className="text-sm text-muted-foreground">{publicViewText}</span>
                </div>
            </div>
        </nav>
    );
    ...
    if (!category) {
        ...
        return (
            <div className="min-h-screen bg-background overflow-x-hidden pt-16 print:pt-0 flex flex-col">
                {/* Navbar */}
                <TournamentNavbar brandText={t("brand")} publicViewText={t("public_view")} />
