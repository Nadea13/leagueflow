    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="ghost" className="w-full rounded-none h-12 font-black uppercase italic tracking-wider text-xs hover:bg-secondary hover:text-secondary-foreground transition-all">
                    {tCommon("edit")}
                </Button>
            </DialogTrigger>
