...
export function DashboardNavbar({
    ...
    return (
        <>
            ...
            <header className={cn("sticky top-0 z-40 flex h-14 md:h-20 items-center justify-between border-b border-border bg-background/80 backdrop-blur-xl px-4 md:px-6 w-full", className)}>
                <div className="flex items-center gap-3">
                    <Link href="/dashboard" className="flex items-center gap-2 transition-transform hover:scale-105 active:scale-95 group">
                        <div className="relative shrink-0">
                            <svg viewBox="0 0 160 160" className="w-7 h-7 md:w-8 md:h-8 drop-shadow-[0_0_8px_rgba(0,196,154,0.3)] transition-all group-hover:drop-shadow-[0_0_12px_rgba(0,196,154,0.5)]" xmlns="http://www.w3.org/2000/svg">
