...
import { getPenaltyShootout, addPenaltyShot, clearPenaltyShootout } from "@/actions/tournaments/penalty";
                ...
                {isLoading ? (
                    ...
                    <div className="p-2 md:p-4 space-y-1 md:space-y-2 relative">
                        ...
                        <div className="flex items-center justify-center gap-10 py-1 md:py-2 border rounded-lg relative z-10 overflow-hidden">
                            ...
                            <span className="text-3xl font-black tracking-tighter relative z-10">-</span>
                            <div className="text-center relative z-10">
                        ...
                        {/* Shot Grid */}
                        <div className="grid grid-cols-[1fr_auto_1fr] gap-1 md:gap-2 relative z-10">
                            <div className="text-[10px] font-black tracking-widest text-center">{homeTeamName}</div>
                            <div className="w-8" />
                            <div className="text-[10px] font-black tracking-widest text-center">{awayTeamName}</div>
                                        ...
                                        <div className="flex justify-center">
                                            {homeShot ? (
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        className="w-12 h-12 rounded-sm border border-foreground/5 bg-foreground/5 hover:bg-primary hover:text-black hover:border-primary flex items-center justify-center group/btn transition-all disabled:opacity-20"
                                                    ...
                                                    <button
                                                        className="w-12 h-12 rounded-sm border border-foreground/5 bg-foreground/5 hover:bg-red-500 hover:text-foreground hover:border-red-500 flex items-center justify-center group/btn transition-all disabled:opacity-20"
                                                ...
                                                <div className="w-12 h-12 rounded-sm border border-foreground/2 bg-foreground/2 opacity-20" />
                                            )}
                                        </div>
